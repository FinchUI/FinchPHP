...
<p>如您不同意上述条款，请勿安装或使用本软件。</p>',
        ...
        'zh-tw' => [
            'title' => '歡迎安裝 Finch PHP',
            'step' => '步驟',
            'step1_title' => '歡迎',
            'step1_desc' => '請選擇介面語言，並閱讀同意使用者協議。',
            'welcome_heading' => '歡迎安裝 Finch PHP',
            'welcome_desc' => 'Finch PHP 是一套輕量、現代、純原生 PHP 8.0+ 開發的通用內容管理系統。安裝精靈將引導您完成初始化設定。',
            'step2_title' => '環境檢查',
            'step2_desc' => '安裝精靈正在檢查伺服器環境是否滿足執行要求。',
            'step3_title' => '站點資訊',
            'step3_desc' => '請填寫站點基本資訊、資料庫設定和管理員帳號。',
            'step4_title' => '安裝完成',
            'next' => '下一步',
            'prev' => '上一步',
            'submit' => '開始安裝',
            'language' => '介面語言',
            'license_agree' => '我已閱讀並同意使用者協議',
            'license_title' => '使用者協議與免責聲明',
            'license_content' => '<p>歡迎使用 Finch PHP 內容管理系統。在安裝前，請仔細閱讀以下條款：</p>
<ol>
<li><strong>軟體性質</strong>：Finch PHP 是開源軟體，按「原樣」提供，不提供任何明示或暗示的保證。</li>
<li><strong>使用責任</strong>：使用者需自行承擔使用本軟體的風險，作者不對因使用本軟體造成的任何直接或間接損失負責。</li>
<li><strong>資料安全</strong>：建議定期備份資料庫和檔案，作者不對資料遺失負責。</li>
<li><strong>安全更新</strong>：使用者有責任及時套用安全更新和修補程式。</li>
<li><strong>合規使用</strong>：使用者應確保其使用方式符合當地法律法規。</li>
<li><strong>開源協議</strong>：本軟體遵循 MIT 開源協議，詳見專案根目錄 LICENSE 檔案。</li>
</ol>
<p>如您不同意上述條款，請勿安裝或使用本軟體。</p>',
            'license_required' => '請閱讀並同意使用者協議後才能繼續安裝。',
            'check_pass' => '通過',
            'check_fail' => '未通過',
            'check_continue' => '所有必選檢查已通過，可以繼續安裝。',
            'check_blocked' => '存在必選檢查未通過，請先解決上述問題。',
            'site_info' => '站點資訊',
            'site_name' => '站點名稱',
            'site_url' => '站點網址',
            'timezone' => '時區',
            ...
            'sqlite_hint' => '相對路徑會基於站點根目錄解析，預設寫入 storage/data/finch.sqlite。',
            'mysql_host' => 'MySQL 主機',
            'mysql_port' => 'MySQL 連接埠',
            'mysql_database' => 'MySQL 資料庫名稱',
            'mysql_username' => 'MySQL 使用者名稱',
            ...
            'installed_desc' => '偵測到當前站點已經完成安裝。為避免覆蓋現有資料，安裝精靈已停止。',
            'enter_admin' => '進入後台',
            'visit_home' => '造訪首頁',
            'locked_title' => '偵測到安裝鎖',
            'locked_desc' => '當前站點存在 storage/data/install.lock，但沒有可用的已安裝設定。若這是一次中斷安裝，請先備份資料，再手動刪除安裝鎖後重新進入精靈。',
            'success_title' => '安裝完成',
            'success_desc' => 'Finch PHP 已經完成初始化。已執行遷移 %d 個，config.php 已生成。',
            'success_home_url_label' => '首頁網址',
            'success_admin_url_label' => '後台網址',
            'login_admin' => '登入後台',
            'errors_title' => '需要處理的問題',
            'error_site_name_empty' => '站點名稱不能為空。',
            'error_site_url_invalid' => '站點網址格式不正確。',
            'error_timezone_invalid' => '時區不在 PHP 支援列表中。',
            'error_driver_invalid' => '資料庫驅動只能選擇 sqlite 或 mysql。',
            'error_prefix_invalid' => '資料表前綴只能包含字母、數字、底線，並且不能以數字開頭。',
            'error_sqlite_no_ext' => '當前 PHP 未啟用 pdo_sqlite，不能使用 SQLite 安裝。',
            'error_sqlite_path_empty' => 'SQLite 資料庫路徑不能為空，也不能使用 :memory:。',
            'error_sqlite_dir_create' => '無法建立 SQLite 資料庫目錄：%s',
            'error_sqlite_dir_write' => 'SQLite 資料庫目錄不可寫入：%s',
            'error_sqlite_is_dir' => 'SQLite 資料庫路徑不能是目錄。',
            'error_mysql_no_ext' => '當前 PHP 未啟用 pdo_mysql，不能使用 MySQL/MariaDB 安裝。',
            'error_mysql_host_empty' => 'MySQL 主機不能為空。',
            'error_mysql_port_invalid' => 'MySQL 連接埠不正確。',
            'error_mysql_db_empty' => 'MySQL 資料庫名稱不能為空。',
            'error_mysql_user_empty' => 'MySQL 使用者名稱不能為空。',
            'error_admin_username_invalid' => '管理員使用者名稱需為 3-50 位字母、數字或底線。',
            'error_admin_email_invalid' => '管理員電子郵件格式不正確。',
            'error_admin_password_short' => '管理員密碼至少 8 位。',
            'error_admin_password_mismatch' => '兩次輸入的管理員密碼不一致。',
            'error_admin_password_complexity' => '管理員密碼必須同時包含字母和數字。',
            'error_config_exists' => 'config.php 已存在。為避免覆蓋現有站點，請先確認並手動移除該檔案後再安裝。',
            'error_install_locked' => '偵測到安裝鎖。若確需重新安裝，請先備份資料並手動刪除 storage/data/install.lock。',
            'error_install_failed' => '安裝失敗：%s',
            'env_php_version' => 'PHP 版本 >= 8.0',
            'env_pdo' => 'PDO 擴充套件',
            'env_pdo_driver' => '至少一種 PDO 資料庫驅動',
            'env_json' => 'json 擴充套件',
            'env_mbstring' => 'mbstring 擴充套件',
            'env_session' => 'session 擴充套件',
            'env_openssl' => 'openssl 擴充套件',
            'env_fileinfo' => 'fileinfo 擴充套件',
            'env_gd' => 'gd 擴充套件',
            'env_curl' => 'curl 擴充套件',
            'env_pdo_sqlite' => 'pdo_sqlite 擴充套件',
            'env_pdo_mysql' => 'pdo_mysql 擴充套件',
            'env_config_writable' => '站點根目錄可寫入 config.php',
            'env_storage_writable' => 'storage/data 可寫入',
            'env_logs_writable' => 'storage/logs 可寫入',
            'env_uploads_writable' => 'content/uploads 可寫入',
        ],
        'en' => [
