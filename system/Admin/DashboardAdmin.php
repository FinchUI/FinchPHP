...
final class DashboardAdmin extends BaseController
{
    public function index(): Response
    {
        ...
        $body = '<h1>仪表盘</h1>'
            ...
            . '<p><a href="/admin/posts">文章管理</a> · <a href="/admin/pages">页面管理</a> · <a href="/admin/categories">分类管理</a> · <a href="/admin/tags">标签管理</a> · <a href="/admin/comments">评论管理</a> · <a href="/admin/users">用户管理</a> · <a href="/admin/tokens">Token 管理</a> · <a href="/admin/extensions">扩展管理</a> · <a href="/admin/uploads">媒体库</a> · <a href="/admin/settings">系统设置</a></p>'
            . $this->logoutForm();
    ...
    private function layout(string $title, string $body): string
    {
        return '<!DOCTYPE html><html lang="zh-cn"><head><meta charset="utf-8">'
            ...
            . '<nav style="margin-bottom:1.5rem"><a href="/admin">后台首页</a> · <a href="/">访问站点</a></nav>'
            . $body
            . '</body></html>';
    }
